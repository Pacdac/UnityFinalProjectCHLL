...
public class BreakableWindow : MonoBehaviour {
    ...
    public bool ShoulDestroySpinters = false;
    [Space]
    ...
    private void generateSingleSplinter(int[] tris, Transform parent)
    {
        ...
        obj.transform.position = new Vector3(vertices[tris[0]].x * transform.localScale.x + transform.position.x, 0, transform.position.z);
